...
summary_table(taxon="Calycolpus", rank="genus", area=get_wgsrpd3_codes("Brazil"),
...
```{r myrciaria-summary}
summary_table(taxon="Myrciaria", rank="genus", area=get_wgsrpd3_codes("Brazil"), 
              grouping.var="area_code_l3") %>% 
  summary_table_gt()
```
...
```{r myrciaria-matrix}
m <- generate_occurrence_matrix(taxon="Myrciaria", rank="genus", 
...
```{r fritilaria-matrix}
m <- generate_occurrence_matrix("Fritillaria", "genus", 

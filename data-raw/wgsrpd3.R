...
north_with_eq <-   c("ABT", "AFG", "ALA", "ALB", "ALG", "ALT", "ALU", "AMU", "AND",
           ...
           "YEM", "YUG", "YUK", "ZAI")
north_without_eq <-  c("ABT", "AFG", "ALA", "ALB", "ALG", "ALT", "ALU", "AMU", "AND",
          "ARI", "ARK", "ARU", "ASK", "ASS", "AUT", "AZO", "BAH", "BAL",
          ...
          "YAK", "YEM", "YUG", "YUK")
south_with_eq <-  c("AGE", "AGS", "AGW", "ALD", "ANG", "ANT", "ASC", "ASP", "ATP",
...
south_without_eq <-  c("AGE", "AGS", "AGW", "ALD", "ANG", "ANT", "ASC", "ASP", "ATP",

...
match_data <- tibble(
  taxonId=c("taxon1", "taxon2", "taxon3", "taxon4", "taxon5", "taxon6"),
  ...
  species=c("annua", "acuminatissima", "angulatum", "almasensis", "almosensis", "mutabilis"),
  infra_rank=c(NA_character_, NA_character_, "var.", NA_character_, NA_character_, "var"),
  infra=c(NA_character_, NA_character_, "angulatum", NA_character_, NA_character_, "americana"),
...
lookup_data <- tibble(
  ...
  taxon_name=c("Poa annua", "Myrcia acuminatissima", "Myrcia acuminatissima",
               ...
               "× Tromostapelia mutabilis var. americana"),
  ...
  taxon_authors=c("L.", "Hieron.", "O.Berg", "(Urb.) K.Campbell & K.Samra",
                  "", "(Guill. & Perr.) Mast.", "NicLugh.", "P.V.Heath"),
  family=c("Poaceae", "Myrtaceae", "Myrtaceae", "Myrtaceae", "Malvaceae",
           "Malvaceae", "Myrtaceae", "Apocynaceae"),
  ...
  homotypic_synonym=c(NA, NA, NA, NA, NA, NA, NA, NA)
)
